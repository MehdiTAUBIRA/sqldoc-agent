                        ...
                        <div class="flex items-center mb-4">
                            <div class="flex-1">
                                ...
                                <div class="inline-flex items-start mt-1 mb-2 text-sm text-red-600 bg-blue-50 p-2 rounded-md">
                                    ...
                                    <span>Make sure the port is accessible and not blocked by a firewall, and that you have the full acces to the database.</span>
                                    <span>Check with your admin.</span>
                                </div>
