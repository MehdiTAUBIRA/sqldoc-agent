                            ...
                            <div class="flex-1">
                                ...
                                <div class="inline-flex items-start mt-1 mb-2 text-sm text-red-600 bg-blue-50 p-2 rounded-md">
                                    ...
                                    <div class="flex flex-col">
                                        <span class="block">Make sure the port is accessible and not blocked by a firewall.</span>
                                        <span class="block">Check that you have full access to the database.</span>
                                        <span class="block">Check with your admin.</span>
                                    </div>
                                </div>
